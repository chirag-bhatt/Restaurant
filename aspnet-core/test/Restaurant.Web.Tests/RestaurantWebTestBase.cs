...
{
    public abstract class RestaurantWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RestaurantWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RestaurantWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RestaurantDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RestaurantDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RestaurantDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RestaurantDbContext, Task<T>> func)
        {
            T result;
